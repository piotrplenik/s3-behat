...
/*
 * This file is part of the jupeter/s3-behat platform.
 *
 * © Piotr Plenik
...
class TestAppKernel extends AppKernel
{
    ...
    public function shutdown()
    {
        ...
        if (!in_array($this->getEnvironment(), array('test', 'test_cached'), true)) {
            parent::shutdown();
    ...
    {
        return array_merge(parent::registerBundles(), array(new DAMA\DoctrineTestBundle\DAMADoctrineTestBundle()));
    }
    ...
    protected function cleanupContainer(ContainerInterface $container)
    {
        ...
        $services = $containerServicesPropertyReflection->getValue($container) ?: array();
